...
# --- render_prompt() — the stateless function --------------------------------

def test_render_prompt_fills_a_slot():
    assert render_prompt("Hello {name}.", {"name": "Sam"}) == "Hello Sam."


def test_unfilled_slot_is_left_literal():
    """A `.prompt` slot is optional — unfilled means literal text, not error."""
